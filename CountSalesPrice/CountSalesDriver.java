...
public class CountSalesDriver {
    public static void main (String[] args) throws Exception {
        ...
        job.setMapperClass(CountSalesPrice.CountSalesMapper.class);
        job.setCombinerClass(CountSalesPrice.CountSalesReducer.class);
        job.setReducerClass(CountSalesPrice.CountSalesReducer.class);
